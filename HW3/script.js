...
for (let { name: name, lastName: lastName, age: age } of characters) {
  const person = { name: name, lastName: lastName, age: age };
  charactersShortInfo.push(person);
}
...
const newEmployee = { ...employee, age: 51, salary: 15000 + ' грн' };
